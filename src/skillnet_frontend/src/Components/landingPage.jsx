        ...
        {carouselItems.map((item, index) => (
          ...
          >
            <div className="text-center px-4 max-w-4xl">
              ...
              <button onClick={handleLogin} disabled={isAuthenticating} className="bg-white text-purple-700 px-8 py-3 rounded-full text-lg font-semibold hover:bg-purple-100 transition duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {group.courses.map((course, courseIndex) => (
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <img src={`/assets/images/courses/${course.image}`} alt={course.title} className="w-full h-48 object-cover" />
                  <div className="p-6">
